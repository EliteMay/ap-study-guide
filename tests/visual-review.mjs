...
try {
  ...
  const primaryPages = [
    ...
    ['html/unit.html?unit=database','unit-database'],
    ['html/lesson.html?id=DB-03','lesson-database-normalization'],
    ['html/lesson.html?id=DB-05','lesson-database-select'],
    ['html/lesson.html?id=DB-09','lesson-database-transaction'],
  ...
  console.log(`[visual-review] OK: ${primaryPages.length} primary routes captured on desktop + mobile, including Phase 1 Foundation, Algorithm, Computer Systems, UI/Media and Database routes, without console errors, horizontal overflow, or unfocused skip-link exposure.`);
} finally {
  await browser.close();
}
