...
console.log(`[mock] OK: Subject A ${practiceChoices.length}+${extraQuestions.length}=80 choices / 150min; Subject B 11 offered, 5 answered / 150min; r16 home/progress integrated.`);