...
try {
  ...
  if (!await page.locator('a[href="practice.html?unit=algorithm-programming&question=PC-ALG-01"]').isVisible()) throw new Error('ALG-01 direct practice link missing');
